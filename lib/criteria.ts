...
export const INDICATORS: Record<IndicatorId, IndicatorDef> = {
  ...
  "3.2": {
    ...
    options: [
      ...
      {
        points: 10,
        label: "ต้องใช้พาหนะมากกว่า 1 ประเภทต่อเที่ยว หรือเดินเท้าตั้งแต่ 2 กม. หรือขึ้นกับสภาพอากาศ/ระดับน้ำ",
      },
    ],
  },
  "3.3": {
  ...
  "5.1": {
    ...
    options: [
      ...
      {
        points: 5,
        label: "พื้นที่เสี่ยงสูง อยู่ในประกาศสถานการณ์ฉุกเฉิน กฎอัยการศึก หรือมีเหตุความไม่สงบย้อนหลังภายใน 3 ปี",
      },
    ],
  },
  "5.2": {
