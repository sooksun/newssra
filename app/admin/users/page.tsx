        ...
        <div className="home-head">
          <div>
            ...
            <p>
              ...
              <strong>เจ้าหน้าที่ สพฐ.</strong> เห็น/แก้ไขได้ทุกโรงเรียน • <strong>โรงเรียน</strong> เห็น/แก้ไขได้เฉพาะโรงเรียนตน (ผูกด้วยรหัสโรงเรียน)
            </p>
            <p className="admin-hint">
              หน้านี้จัดการเฉพาะบัญชีในระบบใหม่ — โรงเรียนส่วนใหญ่เข้าสู่ระบบด้วย<strong>บัญชีเดิม</strong> (รหัส 8 หลัก) จากตาราง <code>user</code> อยู่แล้ว โดยไม่ต้องสร้างที่นี่
            </p>
          </div>
        </div>
